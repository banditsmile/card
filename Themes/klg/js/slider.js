...
function ContentSlider(sliderid, autorun, customPaginateText, customNextText){
	...
	for (var i=0; i<alldivs.length; i++){
		...
		else if (alldivs[i].className=="slider_ad"){
...
ContentSlider.buildpagination=function(sliderid){
	var slider=document.getElementById(sliderid)
	var paginatediv=document.getElementById("paginate_"+sliderid) //reference corresponding pagination DIV for slider
	var pcontent=""
...
ContentSlider.turnpage=function(sliderid, thepage){
	var paginatelinks=document.getElementById("paginate_"+sliderid).getElementsByTagName("a") //gather pagination links
...
ContentSlider.autoturnpage=function(sliderid, autorunperiod){
	var paginatelinks=document.getElementById("paginate_"+sliderid).getElementsByTagName("a") //Get pagination links
