...
class PCCheckController extends Controller
{
				...
				public function CheckAgentValid( )
				{
								...
								if ( 0 < $R94e0136c8a )
								{
												...
												$Raac42e4217 = $R5f84c47438->IStaff_Get( $R94e0136c8a, "checktradepwd,tradepwd" );
				...
				public function MACSave( )
				{
								$this->NormalSave( "mac", "MAC" );
				}
				...
				public function CPUSave( )
				{
								$this->NormalSave( "cpu", "CPU" );
				}
				...
				public function HDESave( )
				{
								$this->NormalSave( "hde", "HDE" );
				}
				...
				public function NormalSave( $R6c6f2ffa34, $action )
				{
								...
								$this->ScriptRedirect( "index.php?m=mod_agent&c=PCCheck&a=".$action );
				}
