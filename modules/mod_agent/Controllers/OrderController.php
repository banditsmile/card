...
class OrderController extends Controller
{
				...
				public function Index( )
				{
								...
								if ( 0 < $R657cac7ff2 )
								{
												...
												$R06c518f70e = array( "ordno" => "������", "pname" => "������Ʒ", "czaccount" => "��ֵ�˺�", "qty" => "����", "cprice" => "����", "dollars" => "֧�����", "ordstate" => "����״̬", "orddate" => "����" );
												$Re8872481ab = array( "-1" => "����ʧ��", "0" => "δ����", "1" => "���ڴ�����", "2" => "���ύ����", "2" => "�������" );
												$R026f0167b4 = array( );
												...
												foreach ( $R3db8f5c8bc as $R0f8134fb60 )
												{
																...
																{
																				$R0f8134fb60['ordstate'] = isset( $Re8872481ab[$R0f8134fb60['ordstate']] ) ? $Re8872481ab[$R0f8134fb60['ordstate']] : "δ֪";
																}
																else
																{
																				$R0f8134fb60['ordstate'] = "�������";
																}
				...
				public function Detail( )
				{
								...
								if ( $R0f8134fb60['item']['payment'] == 96 )
								{
												...
												{
																$R0f8134fb60['item']['comsumpscored'] = "���ֶ�����ɾ��";
												}
								}
				...
				public function SendFetion( )
				{
								...
								if ( isset( $R3db8f5c8bc['isalerted'] ) && $R3db8f5c8bc['isalerted'] == 0 )
								{
												...
												$Rbb3e87fa4e = "�����µĶ�����������Ϊ:".$Rdcd9105806." ������ƷΪ��".$R3db8f5c8bc['pname'];
