...
class OrderController extends Controller
{
				...
				public function Deal( $data = array( ) )
				{
								...
								{
												$R3db8f5c8bc['err']['content'] = $R3db8f5c8bc['err']['content']."[����ʧ�ܣ��뱣�������һ��ͨ�Ա��´����¹���]";
								}
								return $R3db8f5c8bc;
				}
				...
				public function OrderDeal( $R56ea904d53 = array( ) )
				{
								...
								$R679e9b9234['err']['idlable'] = $R3db8f5c8bc['ptype'] == 3 ? $Rb41f4f8da0['idlable'] : "����";
								return $R679e9b9234;
				}
				...
				public function OrderRefresh( $R56ea904d53 = array( ) )
				{
								...
								if ( !isset( $R3db8f5c8bc['ordno'] ) )
								{
												...
												{
																$R679e9b9234['err']['errcode'] = 1;
																$R679e9b9234['err']['content'] = "��ֵ�����Ѿ������벻Ҫ�ظ�ˢ�£�";
																return $R679e9b9234;
												}
								}
								else
				...
				public function Complaint( )
				{
								...
								if ( $Rdcd9105806 != "" )
								{
												...
												{
																$this->Alert( "�˶����Ѿ�Ͷ�߹����������Ҫ���䣬��ʹ�������˺ŵ�½ϵͳ�ں�߻ظ����ɻ���ֱ����ϵ����Ա��" );
																$this->CloseWin( );
												}
								}
