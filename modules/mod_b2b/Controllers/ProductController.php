...
class ProductController extends Controller
{
				...
				public function CheckCanBuyTime( )
				{
								...
								{
												$this->Alert( "���ã�ϵͳ������ע���û�".$R768ed9c2d9."����ܹ�����" );
												$this->CloseWin( );
								}
				}
				...
				public function Zone( )
				{
								...
								{
												echo "<font color=\"#cccccc\">��Ʒ�Ѿ�������</font>";
								}
								exit( );
				}
