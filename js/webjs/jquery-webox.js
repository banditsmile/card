...
$.extend({
    webox: function (option) {
        ...
        if (option['Dynamic']) {
            myHtml = '<div class="mainlist"><ul><li><span class="box_txt">动态码：</span><input id="DynamicCode" type="text" name="test" class="yz_text input_width1" /></li><li  id="dynMyLog" class="yz_btn"><input id="OK2" type="button" value="确定登录" class="login_btn1" onclick="firstLogin(false)" /></li><li id="dynLogImg" style="display:none" class="yz_btn"><img style="margin-left:90px;" src="../images/loading1.gif" /><span class="l">正在登录中...</span></li></ul></div>';
        }
        else {
            myHtml = '<div class="mainlist"><ul><li><span class="box_txt">验证码：</span><input id="chkCode" type="text" name="test" class="yz_text input_width2" /><img id="chkCodeImg" src="../webnew/CheckCode.ashx" onclick="this.src=\'../webnew/CheckCode.ashx?r=\'+Math.random()" /></li><li id="chkMyLog" class="yz_btn"><input id="OK2" type="button" value="确定登录" class="login_btn1" onclick="chkCodeLogin()" /></li><li id="chkLogImg" class="yz_btn"  style="display:none"><img style="margin-left:90px;" src="../images/loading1.gif" /><span class="l">正在登录中...</span></li></ul></div>';
        }
        ...
        $(document).ready(function (e) {
            ...
            $('body').append('<div class="background" style="display:none;"></div><div class="webox"  style="z-index:999;width:' + width + 'px;height:' + height + 'px;display:none;"><div id="inside" style="height:' + height + 'px;"><h1 id="locked" onselectstart="return false;">' + (option['title'] ? option['title'] : 'webox') + '<a class="span" href="javascript:void(0);"></a></h1>' + (option['iframe'] ? '<iframe class="w_iframe" style="z-index:-1;width:620px;height:360px;position:absolute;left:-2px;top:-2px;" src="' + option['iframe'] + '" frameborder="0" width="100%" scrolling="no" style="border:none;overflow-x:hidden;height:' + parseInt(height - 30) + 'px;"></iframe>' : option['html'] ? option['html'] : '') + myHtml + '</div></div>');
