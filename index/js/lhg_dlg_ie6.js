		...
		for( var i = 0, l = lhgdlg.childNodes.length; i < l; i++ )
		{
			...
			switch( child.className )
			{
			    case 'contain':
					...
					child.style.height = Math.max( 0, lhgdlg.clientHeight - 7 - 26 );
					break;
				case 'tr':
				...
				case 'tc':
					...
					break;
				case 'ml':
				    child.style.height = Math.max( 0, lhgdlg.clientHeight - 26 - 7 );
					break;
				case 'mr':
				    child.style.left = Math.max( 0, lhgdlg.clientWidth - 7 );
					child.style.height = Math.max( 0, lhgdlg.clientHeight - 26 - 7 );
					break;
				case 'bl':
				    child.style.top = Math.max( 0, lhgdlg.clientHeight - 8 );
					break;
				case 'br':
				    child.style.left = Math.max( 0, lhgdlg.clientWidth - 8 );
					child.style.top = Math.max( 0, lhgdlg.clientHeight - 8 );
					break;
				case 'bc':
				    child.style.width = Math.max( 0, lhgdlg.clientWidth - 7 - 7 );
