...
(function() {
	...
	var dftCfg = {
		...
		minBtn: true,			//是否显示最小化按钮，默认不显示
		minTxt: '最小化',		//最小化按钮的提示文本
		maxBtn: true,			//是否显示最大化按钮，默认不显示
	...
	(function() {
		...
		/*窗体*/
		"<div id='ym-window' style='position:absolute;z-index:10001;display:none'>", IE6 ? "<iframe src='javascript:false' style='width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1'></iframe>": '', "<div class='ym-tl' id='ym-tl'><div class='ym-tr'><div class='ym-tc' style='cursor:move;'><div class='ym-header-text'></div><div class='ym-header-tools'>", "<div class='Dialog_min' title='最小化'><strong>0</strong></div>", "<div class='Dialog_max' title='最大化'><strong>1</strong></div>", "<div class='Dialog_close' title='关闭'><strong>r</strong></div>", "</div></div></div></div>", "<div class='ym-ml' id='ym-ml'><div class='ym-mr'><div class='ym-mc'><div class='ym-body' style='position:relative'></div></div></div></div>", "<div class='ym-ml' id='ym-btnl'><div class='ym-mr'><div class='ym-btn'></div></div></div>", "<div class='ym-bl' id='ym-bl'><div class='ym-br'><div class='ym-bc'></div></div></div>", "</div>",
		/*阴影*/
		...
		var doMax = function() {
			...
			ym_ico[1].className = 'Dialog_normal';
		...
		var doMin = function() {
			...
			ym_ico[0].className = 'Dialog_normal';
		...
		var doNormal = function(init) { //init=true,弹出时调用该函数
			...
			ym_ico[0].className = 'Dialog_min';
			ym_ico[1].className = 'Dialog_max';
		...
		var winVisible = function(visible) {
			...
			ym_body.innerHTML = !curCfg.iframe ? ('<div class="' + curCfg.msgCls + '">' + curCfg.message + '</div>') : "<iframe id='myId' name='myName' style='" + ifmStyle + "' border='0' frameborder='0' src='" + curCfg.message + "'></iframe><div style='" + ifmStyle + ";background:#000;opacity:0.1;filter:alpha(opacity=10);display:none'></div>"; //内容
			(function(el, obj) {
		...
		var redirect = function(args)
		{
		    ...
		    if (page != null)
		    {
		        ...
		        {
		            cal_cord();
		            cur_cord[0] = cur_cord[0] + parseInt((curCfg.width - args.width) / 2);
		            cur_cord[1] = cur_cord[1] + parseInt((curCfg.height - args.height) / 2);
		            curCfg.width = args.width;
		            curCfg.height = args.height;
		            setWinSize(args.width, args.height, cur_cord);
		        }
		        if (args.title)
		        {
		            curCfg.title = args.title;
