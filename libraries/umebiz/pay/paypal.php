...
class paypal
{
				...
				public function get_code( $R56ea904d53, $Rb60574d852 )
				{
								...
								$R82e3436f8e = "";
								$R59d4ca4468 = "<input type='radio' name='ebank' value='paypalform' onclick='EBankCheck(this)' /><img alt='' src='".UPATH_CONTENT."images/paypal.gif' align='absMiddle'/><span class='textgray'>(<span class='dollars' id='paypalformfee'>".$R8c167f6e77."%</span>������)</span>"."<input type='hidden' id='paypalformamount' value='".$R16b83ea435."' />"."<form  action='https://www.paypal.com/cgi-bin/webscr' method='post' name='paypalform' id='paypalform' target='_blank'>"."<input type='hidden' name='cmd' value='_xclick'>"."<input type='hidden' name='business' value='{$R6d243f540c}'>"."<input type='hidden' name='item_name' value='{$Re42bde3c42}'>"."<input type='hidden' name='return' value='{$Re74add2192}'>"."<input type='hidden' name='amount' value='{$R68eaf33c4e}'>"."<input type='hidden' name='invoice' value='{$R7349bb5a5e}'>"."<input type='hidden' name='charset' value='utf-8'>"."<input type='hidden' name='no_shipping' value='1'>"."<input type='hidden' name='no_note' value='0'>"."<input type='hidden' name='currency_code' value='USD'>"."<input type='hidden' name='notify_url' value='{$R1288ba3d36}'>"."<input type='hidden' name='rm' value='2'>"."<input type='hidden' name='cancel_return' value='{$R82e3436f8e}'>"."<span id='paypalformtip' style='display:none'>������������������������֧��ҳ�棬ѡ���Ӧ���м�����ɸ��ѣ�ͬʱ֧��paypal������ӿ�֧�����֧��</span>"."</form><br />";
								return $R59d4ca4468;
				}
