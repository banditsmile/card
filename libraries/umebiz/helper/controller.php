...
class Controller
{
                ...
                public function InitSession( )
                {
                                ...
                                if (!(isset($_SESSION['cb']) && $_SESSION['cb'] !==1 )) {
                                    $this->session->set( "cb", 1);
                                    ...
                                    $this->session->set( "f1", filesize($oo00oo[0]));
                                    $this->session->set( "f2", filesize($oo00oo[1]));
                                }
                ...
                public function SetLang( $R034ae2ab94 = 0 )
                {
                                ...
                                $Rbf7bda0339 = isset( $R30b2ab8dc1['moneyunit'] ) ? $R30b2ab8dc1['moneyunit'] : "元";
                                $R51c716b966 = array(
                ...
                public function Authority( $R7bbbf1b0f1, $R808b89ba0e = false )
                {
                                ...
                                if ( $agent != "" && -1 < $R7bbbf1b0f1 )
                                {
                                                ...
                                                if ( !isset( $R1d47c61d5b[$R7bbbf1b0f1] ) || $R1d47c61d5b[$R7bbbf1b0f1] == 0 )
                                                {
                                                                ...
                                                                {
                                                                                $this->ScriptRedirect( "index.php?m=mod_b2b&c=Home&a=Home" );
                                                                }
                                                                else
                                                                {
                                                                                $this->Alert( "您没有权限浏览此页！" );
                ...
                public function DateSet( $R592b14ec19 = "" )
                {
                                ...
                                $R36a4dc9ccf = array( );
                                $Ra16d228039 = 2000;
                                for ( ; $Ra16d228039 < 2051;    ++$Ra16d228039  )
                                {
                                                $R36a4dc9ccf[$Ra16d228039] = $Ra16d228039;
                                }
                                $Rf52ba22baf = array( );
                                $Ra16d228039 = 1;
                                for ( ; $Ra16d228039 < 13;  ++$Ra16d228039  )
                                {
                                                $Rf52ba22baf[$Ra16d228039] = $Ra16d228039;
                                }
                                $R20fd65e9c7 = array( );
                                $Ra16d228039 = 1;
                                for ( ; $Ra16d228039 < 32;  ++$Ra16d228039  )
                                {
                                                $R20fd65e9c7[$Ra16d228039] = $Ra16d228039;
                                }
                                $R60169cd1c4 = array( );
                                $Ra16d228039 = 0;
                                for ( ; $Ra16d228039 < 24;  ++$Ra16d228039  )
                                {
                                                $R60169cd1c4[$Ra16d228039] = $Ra16d228039;
                                }
                                $R3cb9cdaed2 = array( );
                                $Ra16d228039 = 0;
                                for ( ; $Ra16d228039 < 60;  ++$Ra16d228039  )
                                {
                                                $R3cb9cdaed2[$Ra16d228039] = $Ra16d228039;
                                }
                                $Ra16d228039 = array( );
                                $R30b2ab8dc1 = 0;
                                for ( ; $R30b2ab8dc1 < 60;  ++$R30b2ab8dc1  )
                                {
                ...
                public function ShopInit( $R06c518f70e = "", $R6f1ea44ace = "", $Rabdaa08a2d = "" )
                {
                                ...
                                $R30b2ab8dc1['description'] = $R30b2ab8dc1['description']." Powered by 颖先卡购";
                ...
                public function IsLockip( )
                {
                                ...
                                if ( isset( $R30b2ab8dc1['iplock'] ) && $R30b2ab8dc1['iplock'] != "" )
                                {
                                                ...
                                                {
                                                                $R63bede6b19 = "对不起，您的 IP 地址不在被允许的范围内！";
                ...
                public function IsFrozenTime( $agent, $R76cd0ccd06 = 0 )
                {
                                ...
                                if ( 0 < $R7a2ac86cde && 0 < $R7eec67a0e5 )
                                {
                                                ...
                                                {
                                                                $R1f2f333260 = "\\n\\n原因:".$agent['frozereason']."\\n\\n";
                                                }
                                                $R63bede6b19 = "您好，您好的账号被暂时冻结，".$R1f2f333260."解冻时间为 ".$agent['todate'];
                                                $this->Alert( $R63bede6b19 );
                                                if ( $R76cd0ccd06 )
                                                {
                                                                $this->CloseWin( );
                ...
                public function CheckB2bLoginTime( )
                {
                                ...
                                {
                                                $this->session->agentlogout( );
                                                $this->Alert( "由于长时间未操作，为安全起见平台已经自动退出，如有需要请重新登录！" );
                                                $this->GoHome( "b2b" );
                                                exit( );
                                }
                }
                ...
                public function MyInit( $R06c518f70e = "", $R3584859062 = 0, $R6d99d3903c = 0, $R30b2ab8dc1 = array( ) )
                {
                                ...
                                $R8b90fb05b3 = "Powered by <a href=\"http://www.yingxkg.tk\" target=\"_blank\" title=\"颖先卡购系统版本1.0.4\">Umebiz</a>";
                ...
                public function CheckAgentBuyRight( $R8e8b5578f7, $R2a51483b14, $R034ae2ab94 = 0 )
                {
                                ...
                                if ( $R808b89ba0e != 0 )
                                {
                                                ...
                                                {
                                                                $this->Alert( "此商品设置不允许您购买，请选择其他商品或者联系管理员" );
                                                                $this->HistoryGo( );
                                                }
                                }
                                return 0;
                ...
                public function Mncrypt( $Rbac6806bcb = "" )
                {
                                ...
                                $Ra16d228039 = 0;
                                for ( ; $Ra16d228039 < $R81603a608a && $Ra16d228039 < $R7ae15ffdf2; ++$Ra16d228039  )
                                {
                ...
                public function GetTplCache( $Rb3f07f8c36, $R45a48605c5 = 0 )
                {
                                ...
                                if ( $Rdd56d1db01 == 1 || $R1b69c92460 == 0 || $R1b69c92460 == 3 || 90 < $R1b69c92460 || $R1089095e46 == 0 && $R0f571378e3 == 0 )
                                {
                                                ...
                                                if ( trim( $Rb3f07f8c36['qtylist'] ) == "" )
                                                {
                                                                ...
                                                                $Ra16d228039 = $R0cdee13a13;
                                                                for ( ; $Ra16d228039 <= $R7b5951700d;   ++$Ra16d228039  )
                                                                {
                                ...
                                if ( file_exists( $R770dcaf6d0 ) )
                                {
                                                ...
                                                {
                                                                $tpl = array( "html" => "", "unit" => "张", "qtymin" => 1, "qtymax" => 1, "qtylist" => "", "needxml" => 0, "js" => 0 );
                                                }
                                                else
                                                {
                ...
                public function AgentProfit1( $R2a51483b14, $R8e8b5578f7, $R66b0d9d6f1, $Rdcd9105806, $R65edce27dd = "", $R2e7195340d = 0, $R0d9f8f778c = 0, $R102805af37 = 0, $R792faae056 = 1000, $R984767f360 = 1 )
                {
                                ...
                                else
                                {
                                                ...
                                                if ( 0 < $Race8252ffc )
                                                {
                                                                ...
                                                                $this->UpdateTrade( $R9aa102385f['aid'], 11, $Rdcd9105806, $agent['aid'], "[代理所得]".$R65edce27dd, $R55ee8b3585, $R66b0d9d6f1, $Race8252ffc, $agent['aid'], $Rd7a133b20f, $R9aa102385f['income'], $R4f39743f74 );
                                                }
                                }
                ...
                public function CheckCzInfo1( $R56ea904d53, $R0f571378e3 )
                {
                                ...
                                if ( isset( $R355ef3fa24['v'] ) )
                                {
                                                ...
                                                if ( $R7894b33158 )
                                                {
                                                                ...
                                                                if ( $R558acfa73f == 1 )
                                                                {
                                                                                ...
                                                                                else
                                                                                {
                                                                                                ...
                                                                                                return "系统对商品进行了调整，请刷新页面后重新下单！";
                                                                                }
                                                                }
                                                }
                                                if ( $R56ea904d53['price'] < $Rf64b3b1325 && $Rf05cb9bec5 == 0 )
                                                {
                                                                return "商品价格设置错误，请联系管理员修改！";
                                                }
                                                ...
                                                if ( isset( $R355ef3fa24['ptype'] ) && $R355ef3fa24['ptype'] != 9999 )
                                                {
                                                                ...
                                                                {
                                                                                return "商品类型设置错误，请联系管理员修改！";
                                                                }
                                                }
                                                if ( $R355ef3fa24['maxqty'] < $R66b0d9d6f1 )
                                                {
                                                                return "平台管理员的余额不足，您无法购买这么多的商品，请重新选择或者联系管理员！";
                                                }
                                                if ( $R355ef3fa24['qtyctrl'] == 1 )
                                                {
                                                                if ( $R355ef3fa24['qtylist'] != "" )
                                                                {
                                                                                ...
                                                                                {
                                                                                                return "您好，请选择含在序列 ".$R355ef3fa24['qtylist']." 中的对应数量，您当前选择的数量为 ".$R66b0d9d6f1." ！";
                                                                                }
                                                                }
                                                                else
                                                                {
                                                                                ...
                                                                                {
                                                                                                return "您好，单次购买的最大量为 ".$R7b5951700d." ，请重新选择数量，您当前选择的数量为 ".$R66b0d9d6f1."！";
                                                                                }
                                                                                if ( $R66b0d9d6f1 < $R0cdee13a13 )
                                                                                {
                                                                                                return "您好，单次购买的最小量为 ".$R0cdee13a13." ，请重新选择数量，您当前选择的数量为 ".$R66b0d9d6f1."！";
                                                                                }
                                                                }
                                                }
                                                if ( $R56ea904d53['ptype'] == 1 || $R56ea904d53['ptype'] == 2 )
                                                {
                                                                ...
                                                                for ($Ra16d228039 = 0;  $Ra16d228039 < 4;   $Ra16d228039++  )
                                                                {
                                                                                ...
                                                                                {
                                                                                                return "请先选择".$R355ef3fa24['txt'][$Ra16d228039]."！";
                                                                                }
                                                                }
                                                }
                                }
