...
class tradeshistory extends mysql
{
				...
				public function &ITrade_Page( $data = array( ), $R9afaabccd6 = "*" )
				{
								...
								return $this->PageRecord( "tradeshistory", $R71a6fd054f, $R42c553e7de, $this->GetPageLimit( $data ), $R9afaabccd6, true, "tid" );
				}
				...
				public function &ITrade_GetByYktNumber( $R1df8368da5, $Rb0d5d47f3d = "*", $R5cc00cfbe4 = false )
				{
								...
								if ( $R5cc00cfbe4 )
								{
												$R130d64a4ad = "select ".$R63bede6b19.",t1.failreason,t1.factoryreturn from ".$this->dbprefix."tradeshistory t0 left join ".$this->dbprefix."ordershistory t1 on (t1.ordno=t0.ordno) where t0.yktnumber='".$R1df8368da5."' and t0.aid=0 order by t0.tid desc";
								}
								else
								{
												$R130d64a4ad = "select ".$R63bede6b19.",t1.failreason,t1.factoryreturn from ".$this->dbprefix."tradeshistory t0 left join ".$this->dbprefix."ordershistory t1 on (t1.ordno=t0.ordno) where t0.yktnumber='".$R1df8368da5."' and t0.state>-1 and t0.aid=0 order by t0.tid desc";
								}
				...
				public function &ITrade_Get( $Rdcd9105806, $Rb0d5d47f3d = "*" )
				{
								...
								$R679e9b9234 = $this->SelectRecord( "tradeshistory", $Rb0d5d47f3d );
				...
				public function ITrade_Update( $R7d89c4df3d = array( ), $R3584859062 )
				{
								$this->reset( );
								foreach ( $R7d89c4df3d as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
												$this->add( $Ra09fe38af3, $Ra3d52e52a4 );
								}
								return $this->UpdateRecord( "tradeshistory", "tid = ".$R3584859062 );
				}

				public function ITrade_UpdateByOrdno( $R7d89c4df3d = array( ), $Rdcd9105806 )
				{
								$this->reset( );
								foreach ( $R7d89c4df3d as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
								...
								return $this->UpdateRecord( "tradeshistory", "ordno = '".$Rdcd9105806."'" );
				}

				public function ITrade_UpdateByYkt( $R7d89c4df3d = array( ), $Rdcd9105806, $R1df8368da5 )
				{
								$this->reset( );
								foreach ( $R7d89c4df3d as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
								...
								return $this->UpdateRecord( "tradeshistory", "ordno = '".$Rdcd9105806."' and yktnumber = '".$R1df8368da5."'" );
				}

				public function ITrade_Create( $R7d89c4df3d = array( ) )
				{
								$this->reset( );
								foreach ( $R7d89c4df3d as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
								...
								return $this->InsertRecord( "tradeshistory" );
				}

				public function ITrade_Del( $R755ba04a49 )
				{
								return $this->DeleteRecord( "tradeshistory", "tid = ".$R755ba04a49 );
				}

				public function &ITrade_YktPage( $data = array( ) )
				{
								$R130d64a4ad = "select t.createdate,t.fat,t.fbt,o.pname,o.ptype,o.qty,o.cprice,o.dollars,c.cardnumber,c.price,c.pname as cardname,o.ordno from ".$this->dbprefix."tradeshistory t "."left join ".$this->dbprefix."ordershistory o on t.ordno=o.ordno "."left join ".$this->dbprefix."cards c on c.id=t.ykt "."%s group by tid order by tid";
								$R026f0167b4 = "";
				...
				{
								$R130d64a4ad = "select ".$Rb0d5d47f3d." from ".$this->dbprefix."tradeshistory %s";
								$R026f0167b4 = "";
				...
				{
								$R130d64a4ad = "select ".$R4454e360ff."  from ".$this->dbprefix."tradeshistory where ".$Rb7492a73f7;
				...
				public function ITrade_UpdateByStr( $data = array( ), $R63bede6b19 )
				{
								...
								return $this->UpdateRecord( "tradeshistory", $R63bede6b19 );
				}

				public function ITrade_UpdateStrByStr( $R63bede6b19, $R42f28414d6 )
				{
								$R130d64a4ad = sprintf( "update %s set %s where %s", $this->dbprefix."tradeshistory", $R63bede6b19, $R42f28414d6 );
