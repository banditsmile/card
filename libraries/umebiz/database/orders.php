...
class orders extends mysql
{
				...
				{
								$R130d64a4ad = "select o.pid,o.pname,o.ptype,t0.namecolor,t0.isbold,t0.listprice,t0.pid,t0.pricetpl,t0.hassup,t0.onsup,t0.price,t0.canmakeprice, t0.stocks as mystocks,t0.aid as owner,t0.forb2b,t0.inrecycle,t0.checked,t0.sell,t0.tosys from ".$this->dbprefix."orders o "."left join ".$this->dbprefix."products t0 on t0.pid=o.pid "."%s group by o.pid";
								$R026f0167b4 = "";
								...
								foreach ( $R3db8f5c8bc as $R0f8134fb60 )
								{
												...
												if ( 0 < $R8e8b5578f7 )
												{
																$R130d64a4ad = "select count(0) as count from ".$this->dbprefix."orders o where o.pid=".$R0f8134fb60['pid']." %s";
																$R4945e6b9f8 = "select sum(dollars) as count from ".$this->dbprefix."orders o where o.pid=".$R0f8134fb60['pid']." %s";
																$R3274156ee9 = "select sum(qty) as count from ".$this->dbprefix."orders o where o.pid=".$R0f8134fb60['pid']." %s";
																if ( $R42f28414d6 != null )
																{
				...
				{
								$R130d64a4ad = "select o.*, (select company from ".$this->dbprefix."agents a where a.aid=o.aid) as company "."from ".$this->dbprefix."orders o "."%s order by id desc";
								$R026f0167b4 = "";
								$R42f28414d6 = $this->GetPageLimit( $data, "o." );
								if ( $R42f28414d6 != null )
								{
				...
				{
								$R130d64a4ad = "select ".$R4454e360ff."  from ".$this->dbprefix."orders where ".$Rb7492a73f7;
								return $this->QuerySelect( $R130d64a4ad );
				}

				public function IOrder_GetByPageLimit( $data, $R4454e360ff = "*" )
				{
								$R130d64a4ad = "select ".$R4454e360ff."  from ".$this->dbprefix."orders";
				...
				public function IOrder_Get( $Rdcd9105806, $R45074ab3da = "", $R5d899a20a5 = "", $R4454e360ff = "*", $R89c4676b80 = 0 )
				{
								...
								$R679e9b9234 = $this->SelectRecord( "orders", $R4454e360ff );
				...
				{
								$R130d64a4ad = "select count(0) as count from ".$this->dbprefix."orders where ordstate=1";
								$R679e9b9234 = $this->QuerySelect( $R130d64a4ad );
								return $R679e9b9234;
				}

				public function IOrder_Update( $R459cf7ef38 = array( ), $Rdcd9105806 )
				{
								$this->reset( );
								$R459cf7ef38 = $this->AdjustTime( $R459cf7ef38 );
								foreach ( $R459cf7ef38 as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
												$this->add( $Ra09fe38af3, $Ra3d52e52a4 );
								}
								return $this->UpdateRecord( "orders", "ordno = '".$Rdcd9105806."'" );
				}

				public function IOrder_UpdateByStr( $R459cf7ef38 = array( ), $R63bede6b19 )
				{
								$this->reset( );
								$R459cf7ef38 = $this->AdjustTime( $R459cf7ef38 );
								foreach ( $R459cf7ef38 as $Ra09fe38af3 => $Ra3d52e52a4 )
								...
								return $this->UpdateRecord( "orders", $R63bede6b19 );
				}

				public function IOrder_Create( $R459cf7ef38 = array( ) )
				{
								$this->reset( );
								$R459cf7ef38 = $this->AdjustTime( $R459cf7ef38 );
								foreach ( $R459cf7ef38 as $Ra09fe38af3 => $Ra3d52e52a4 )
								...
								return $this->InsertRecord( "orders" );
				}

				public function IOrder_DeleteByOrdno( $Rdcd9105806 )
				{
								return $this->DeleteRecord( "orders", "ordno = '".$Rdcd9105806."'" );
				}
				...
				public function IOrder_Delete( $R3584859062 )
				{
								...
								return $this->UpdateRecord( "orders", "id in (".$R3584859062.")" );
				}
				...
				public function IOrder_DeleteByStr( $R63bede6b19, $data )
				{
								...
								return $this->UpdateRecord( "orders", $R172196908b );
				}

				public function IOrder_Destroy( $R3584859062 )
				{
								return $this->DeleteRecord( "orders", "id in (".$R3584859062.")" );
				}
				...
				public function IOrder_DestroyByStr( $R63bede6b19, $data )
				{
								...
								return $this->DeleteRecord( "orders", $R172196908b );
				}
				...
				public function IOrder_QueryRows( $R63bede6b19 )
				{
								...
								$R130d64a4ad = "select * from ".$this->dbprefix."orders %s";
				...
				public function &IOrder_RowsByDate( $data = array( ) )
				{
								...
								foreach ( $data as $Ra09fe38af3 => $Ra3d52e52a4 )
								{
												...
												$R026f0167b4[$Ra09fe38af3] = $this->num_rows( "orders" );
								}
								return $R026f0167b4;
				}
				...
				{
								$R130d64a4ad = "select %s from ".$this->dbprefix."orders %s";
								$R026f0167b4 = "";
								$R42f28414d6 = $this->GetPageLimit( $data, "" );
								if ( $R42f28414d6 != null )
								{
				...
				{
								$R130d64a4ad = "select cprice,qty from ".$this->dbprefix."orders where cname='".$R0dc0347d49."' and (ordstate=2 or ordstate=1) and orddate > '".date( "Y-m-d" )."'";
								$R679e9b9234 = $this->QuerySelect( $R130d64a4ad );
								$R4f6dd3397f = 0;
				...
				{
								$R130d64a4ad = "select buyerprice,qty from ".$this->dbprefix."orders where cname='".$R0dc0347d49."' and cid=".$R2a51483b14." and (ordstate=2 or ordstate=1) and orddate > '".$R696350cab3."' and orddate < '".$R1c8e0f6795."'";
								$R679e9b9234 = $this->QuerySelect( $R130d64a4ad );
								$R4f6dd3397f = 0;
								foreach ( $R679e9b9234 as $R0f8134fb60 )
								{
