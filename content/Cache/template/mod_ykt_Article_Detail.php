<?php widget("head");include($path_cache.DS."mod_ykt_Shared_head.php"); ?>
<div class="artLeft">
<?php $item=$vd['item'] ?>
<input type="hidden" id="id" name="id" value="<?php echo $item['id']; ?>"/>
<b class="rtop" id="articlert" style="margin-top:5px"><b class="r3"></b><b class="r4"></b></b>
<div id="articleTitle"><span class="flright"></span><b> <?php echo $vd['web']['webname']; ?> > <a href="<?php echo $vd['root']; ?>index.php?m=mod_ykt&c=article&a=home&boardid=<?php echo $vd['board']['id']; ?>"><font color="#000"><?php echo $vd['board']['name']; ?></font></a> > 正文 </b></div>
<div id="articleCol">
<table width="100%" border="0" cellpadding="10" cellspacing="0" height="95" style="border-collapse: collapse;">    
  <tr>
...
<b class="rbottom" id="articlerb"><b class="r4"></b><b class="r3"></b></b>
</div>
<div class='artRight'>
  <div id="artrimg">
    <?php foreach($vd['ad'] as $aditem) { ?>
    <?php if($aditem['ispic']==1 && $aditem['pos']==52){ ?>
  ...
  <b class="rtop" id="artrrt" style="margin-top:5px"><b class="r3"></b><b class="r4"></b></b>
  <div id="artrTitle"><span class="flright"></span><b>相关文章</b></div>
  <div id="artrCol">
  <div id="artrCnt" class="box list faq">
    <ul>
      <?php foreach($vd['boardarticle'] as $a) { ?>
      <li>
        <a href="<?php if($a['titlelink'] != ''){ ?><?php echo $a['titlelink']; ?>" target="_blank"<?php }else{ ?><?php echo $vd['root']; ?>article/<?php if($vd['vip'] > 0){ ?>?<?php } ?><?php echo $a['id']; ?>.html" target="_blank"<?php } ?>"> <font color="<?php echo $a['titlecolor']; ?>" title="<?php echo $a['title']; ?>"><?php (SubText($a['title'],22)); ?></font></a></li>
      <?php } ?>
      <li class="endli"></li>
    </ul>
  </div>
  ...
  <div id="articleBottom"></div>
  <b class="rbottom" id="artrrb"><b class="r4"></b><b class="r3"></b></b>
</div>
<script src="<?php echo $vd['content']; ?>js/detail.js"></script>
<div style="clear:both"></div>
<?php widget("foot");include($path_cache.DS."mod_ykt_Shared_foot.php"); ?>
