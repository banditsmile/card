...
<div class="new_qie">
  ...
  <ul>
    <li> <a id="lbtn21" class="on" href="#">在线充值</a></li>
    <li> <a id="lbtn22" href="../index.php?m=mod_agent&c=Funds&a=BankFunds">银行汇款充值</a></li>
...
<script type="text/javascript">
  ...
  .c4 label{vertical-align:middle;}
    ...
    <table cellspacing="1" cellpadding="2" class="table5">
          ...
          <tr>
            <td width="22%" height="30" class="td_left"><div align="right">网上银行卡支付：</div></td>
          ...
          <tr>
            <td width="22%" height="30" class="td_left"><div align="right">手机卡/游戏卡支付：</div></td>
            <td width="78%" class="tableright1">
          ...
          <tr>
            <td width="22%" height="131" class="td_left"><div align="right">第三方支付：</div></td>
            <td width="78%" class="tableright1">
            	<div class="<?php if(count($vd['otherpay']) > 4){ ?>c3<?php }else{ ?>c4<?php } ?>" style="height:<?php echo (count($vd['cardpay'])+3)/4 * 45 ?>px">
            		...
            		<p align="left">
            		  ...
            		  <label for="tenpay"><img src="<?php echo $vd['content']; ?>images/<?php echo $pay['paycode']; ?>.gif" alt="第三方支付"  align="absmiddle" /></label>
          ...
          <?php if($f==1){ ?>
					<tr>
					<td height="49" class="td_left"><div align="right">支付金额：</div></td>
					<td class="tableright1"><div align="left">
				      <input type="text" name="ubzdollars" size='10' value="500.00" class='input_money' style="margin:5px;" /> <?php if(isset($vd['rights'][3]) && $vd['rights'][3] > 0){ ?> 最低充 <font color="#ff0000"><b><?php echo $vd['rights'][3]; ?></b></font> <?php } ?></td>
					</tr>
					<tr>
					<td height="30" class="td_left"><div align="right"></div></td>
					<td class="tableright1" style="padding:5px"><div align="left">
					  <input name="submit" type="submit" class="tijiao_input" value="确认支付">
					</div></td>
					</tr>
					<?php }else{ ?>
          <tr> 
            <td colspan="2">您好，系统管理员尚未配置银行在线付款</td>
          </tr>
          <?php } ?>
          <?php if(isset($vd['bankalert']) && $vd['bankalert'] != ''){ ?>
          <tr> 
            <td class="td_left">充值注意事项　</td>
