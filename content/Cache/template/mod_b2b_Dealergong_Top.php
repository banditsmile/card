...
<li class="qq">���߿ͷ���<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $vd['web']['email']; ?>&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:<?php echo $vd['web']['email']; ?>:51" alt="���߿ͷ�" title="���߿ͷ�"></a></li>
    ...
    <li style="width: 130px"><a href="/index.php?m=mod_b2b&c=Dealergong&a=home" target="ifrpage" style="width: 130px"> ����ϵͳ��ҳ</a></li>

    <li class="li2"></li>

    <li><a href="/index.php?m=mod_agent&c=Product&a=Stock" target="ifrpage">��Ʒ����</a></li>

    <li class="li2"></li>

    <li><a href="/index.php?m=mod_agent&c=funds&a=detail" target="ifrpage">���ת���</a></li>

    <li class="li2"></li>

    <li><a href="/index.php?m=mod_agent&c=AOrder&a=CzOrderList&ptype=sd" target="ifrpage">������ϸ</a></li>
    ...
    setInterval(MsgAlert, 60000);
                ...
                <div class="main" id="menua">
                  ...
                  <ul>
                    ...
                    <li class="li1"><a href="/index.php?m=mod_agent&c=Product&a=Create" target="ifrpage" onfocus="this.blur();">����������Ʒ</a></li>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=Product&a=Stock" target="ifrpage" onfocus="this.blur();">������Ʒ����</a></li>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=Underling&a=Consump" target="ifrpage" onfocus="this.blur();">�¼��ͻ����ѷ���</a></li>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=Product&a=Stock" target="ifrpage" onfocus="this.blur();">������Ʒ������</a></li>

					<li class="li1"><a href="/index.php?m=mod_agent&c=AOrder&a=Simple" target="ifrpage" onfocus="this.blur();">��Ʒ���۱����ѯ</a></li>

                  </ul>

                  <h3 menuid="2" togglegroup="on" class="menutitle"> <span>������������</span></h3>

                  <ul>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=AOrder&a=CzOrder&ptype=sd&ordstate=1&by=1" target="ifrpage" onfocus="this.blur();"> �ֹ������б�</a></li>

                  </ul>

                  <ul>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=trade&tpl=Sup&tradetype=12" target="ifrpage" onfocus="this.blur();">��Ʒ���뱨��</a></li>

                    <li class="li1"><a href="/index.php?m=mod_agent&c=Complaint&msgdirect=1" target="ifrpage" onfocus="this.blur();">����Ͷ�ߴ���</a></li>

					<li class="li1"><a href="/index.php?m=mod_agent&c=AOrder&a=CzOrderList&ptype=sd" target="ifrpage" onfocus="this.blur();">����������ϸ</a></li>

					<li class="li1"><a href="/index.php?m=mod_agent&c=AOrder&a=CzOrderList&ptype=sd" target="ifrpage" onfocus="this.blur();">��Ʒ�����¼</a></li>
...
try{Dialog.w1in({title:'ƽ̨����',iframe:{src:'../index/Announcement.html'},width:500,height:350});}catch(e){}parent.frames['ifrpage'].location.href='/index.php?m=mod_agent&c=Product';//]]>
