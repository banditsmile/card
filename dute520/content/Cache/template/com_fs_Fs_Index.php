...
<script type="text/javascript">
  ...
  {
    //get the name
    document.getElementById("uploadresult").innerHTML = "�ϴ��ɹ�!·����" + fname;
...
<form id="frmUpload" action="" target="eRunningFrame" method="post" enctype="multipart/form-data">
  ...
  <input type="submit" value="�ϴ�" onclick="SetAction();"/>
  <font color="#FF0000"><span id="uploadresult">* (��ѡ��Ҫ�ϴ���ͼƬ,Ȼ�����ϴ���ť)</span></font>
</form>
