  ...
  <tr>
    <td width="100%" colspan="6" style="padding-left:0px;border:1px #cccccc solid;border-top:0px #cccccc solid;font-size:12px;background:#f4f4f4;" valign="top">
      ...
      <div style="width:150px;border:1px #cccccc solid;float:left;margin:5px;">
        ...
        <div style="margin:5px 2px;float:left;"><?php echo $item['name']; ?> [<a href="#" onclick='setup("<?php echo $item['file']; ?>")'>安装</a>]</div>
      </div>
      <?php } ?>
      </div>
    </td>
...
<div id="opcontent" style="height:30px;">
  <div class="optxt">
    第<span id="tthispage" style="font-weight:bold"><?php echo $vd['thispage']; ?></span>页/总<span id="ttotlepage" style="font-weight:bold"><?php echo $vd['totlepage']; ?></span>页 <input type="button" class="button" value="&lt;&lt; 上一页" <?php echo $vd['prestate']; ?> onclick="gopre()" id="gopre"  />
      <input type="button" class="button" value="下一页 &gt;&gt;" <?php echo $vd['nextstate']; ?> onclick="gonext()" id="gonext"  />
    <span id="ccinfo"></span>
  </div>
</div>
  ...
  <?php }else{ ?>
    ...
    <div style="width:150px;border:1px #cccccc solid;float:left;margin:5px;">
      ...
      <div style="margin:10px 2px 3px;float:left;width:95%">
        <?php echo $item['name']; ?> [<a href="#" onclick='down("<?php echo $item['id']; ?>")'>安装</a>][<a href="<?php echo $item['demo']; ?>" target="_blank">演示</a>]
      </div>
      <div style="margin:3px 2px;float:left;width:95%">适用：<?php echo $item['version']; ?></div>
      <div style="margin:3px 2px;float:left;width:95%">作者：<?php echo $item['author']; ?></div>
    </div>
    <?php } ?>
