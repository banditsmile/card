...
<div id="titleDiv">
<div style="float:left"><a href="index.php?a=Home"><img src="<?php echo $vd['sc']; ?>images/home.png" style="vertical-align:middle" border="0"/></a></div><div style="float:left;padding-top:8px;padding-left:3px;"><a href="index.php?a=Home" title="�ص���̨��ҳ"><font color="#000">����</font></a> <span style="font-size:7px;">>></span> <a href="index.php?m=mod_b2b&c=Article" title="�����б�"><font color="#000">�����б�</font></a> <span style="font-size:7px;">>></span> <span style="font-size:12px;"><?php echo $item['title']; ?></span></div>
<div style="float:right;"><a href="index.php?m=mod_home&a=Help&t=admin_b2b_article_detail" onFocus="this.blur()" title="�鿴������ذ���"><img src="<?php echo $vd['sc']; ?>images/help.gif" style="vertical-align:middle" border="0"/></a></div>
</div>
  ...
  <table border="0" class="ctable" bordercolor="#ededed">
    <tr>
      ...
      <td class="tablert">
        ...
        <input type="checkbox" class="checkbox" name="stick" value="1" onFocus="this.blur()" <?php (ToggleCheck($item['stick'])); ?>/> �ö�
        <input type="checkbox" class="checkbox" name="hidden" value="1" onFocus="this.blur()" <?php (ToggleCheck($item['hidden'])); ?>/> ����
      </td>
    </tr>
    <tr> 
      <td class="tablelt">
    ...
    <tr id="titlelink" style="display:none"> 
      <td class="tablelt">
        <strong onmouseover="showhide(this);" onmouseout="showhide(this);">[?]</strong><p>ǰ̨�û�������±���󣬻�ֱ��ת�������ַ���������ת���������</p>
        ת���ַ��
      </td>
      <td class="tablert">
...
<div>
  <table border="0" id="ctable2" class="ctable" bordercolor="#ededed">
    <tr> 
      ...
      <td class="tablert"><input type="text" name="webtitle" value="<?php echo $item['webtitle']; ?>" size="34"/> <span class="spantip">(������Ĭ����ʾ��������)</span></td>
    </tr>
    <tr> 
      <td class="tablelt">
        META_KEYWORDS(ҳ��ؼ���)
