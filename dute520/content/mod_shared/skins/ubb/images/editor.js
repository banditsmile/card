...
function switchEditor(mode) {
	...
	$('bbcodemode').className = mode ? 'editor_switcher' : 'editor_switcher_highlight';
	$('wysiwygmode').className = mode ? 'editor_switcher_highlight' : 'editor_switcher';
