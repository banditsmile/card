...
function toggle_collapse(objname, unfolded) {
	...
	var collapsed = getcookie('ubz_collapse');
	...
	document.cookie = 'ubz_collapse=' + escape(collapsed) + '; expires=' + expires.toGMTString() + '; path=/';
...
function checkFocus() {
	var obj = typeof wysiwyg == 'undefined' || !wysiwyg ? $('message') : editwin;
	if(!obj.hasfocus) {
		obj.focus();
	}
}
