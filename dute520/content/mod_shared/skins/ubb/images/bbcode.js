...
function bbcode2html(str) {
	...
	for(var i = 0; i <= pcodecount; i++) {
		str = str.replace("[\tubz_CODE_" + i + "\t]", codehtml[i]);
	}
...
function parsetable(width, str) {
	...
	var string = '<table '
		+ (width == '' ? '' : 'width="' + width + '" ')
		+ 'align="center" border="1" style="border-collapse:collapse;text-align:center;line-height:30px" bordercolor="#cccccc">';
