...
class CategoryController extends Controller
{
				...
				public function Index( )
				{
								...
								$R00be52aa45 = array( "name" => "����", "pinyin" => "����ĸ", "ordering" => "����" );
				...
				{
								$R030cbb891f = $this->instance->ICategory_GetByName( "֧����" );
				...
				{
								$data = array( "parentid" => 0, "color" => "#000000", "ordering" => 0, "name" => "֧����", "pinyin" => "", "abst" => "", "hot" => 0, "shared" => 0, "forb2b" => 0, "forb2c" => 0, "forykt" => 0, "fork2k" => 1, "fee" => 0, "code" => 0 );
