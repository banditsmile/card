...
class GameController extends Controller
{
				...
				{
								$this->instance = factory::getinstance( "game" );
				}
				...
				public function Index( )
				{
								...
								$R4e420efcc3 = $this->instance->IGame_Page( $data );
				...
				public function Detail( )
				{
								...
								$this->Assign( "item", $this->instance->IGame_GetById( $R3584859062 ) );
				...
				public function Restore( )
				{
								...
								$R808b89ba0e = $this->instance->IGame_UpdateByStr( $data, $Rb7492a73f7 );
								if ( $R808b89ba0e )
								{
												echo "";
								}
				...
				public function DestroyItems( )
				{
								...
								$data = array_merge( $data, $R71a664ef8c );
								$Rb7492a73f7 = $this->GetLit( );
								$R808b89ba0e = $this->instance->IGame_DestroyByStr( $Rb7492a73f7, $data );
								if ( $R808b89ba0e )
								{
												echo "";
								}
				...
				public function Save( )
				{
								...
								$this->go( $R808b89ba0e, $R63bede6b19."�ɹ���", $R63bede6b19."ʧ��", "index.php?m=mod_b2b&c=game&a=index" );
				}
