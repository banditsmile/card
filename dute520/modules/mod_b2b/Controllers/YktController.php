...
class YktController extends Controller
{
				...
				public function BindIndex( )
				{
								...
								$R00be52aa45 = array( "cardnumber" => "卡号", "cardpwd" => "卡密码", "bindaid" => "代理商编号", "cardgroup" => "批次" );
				...
				public function ChildSave( )
				{
								...
								$this->go( $R808b89ba0e, "操作成功", "操作失败", "index.php?m=mod_b2b&c=ykt&a=childs&id=".$R4939d208ed );
				}
				...
				public function ProductSave( )
				{
								...
								$this->go( $R808b89ba0e, $R63bede6b19."成功", $R63bede6b19."失败", "index.php?m=mod_b2b&c=ykt&a=product" );
				}
				...
				public function Save( )
				{
								...
								{
												$this->Alert( "您好,您勾选了绑定代理商,请输入代理商的编号" );
												$this->HistoryGo( );
								}
								...
								$R65edce27dd = $R1b69c92460 == 100 ? "一卡通兑换专用卡" : "一卡通充值专用卡";
								...
								if ( 0 < $Rc918c9e179 )
								{
												...
												if ( 0 < $R670974c812 )
												{
																...
																{
																				$this->Alert( "要导入的商品不存在，请重新选择" );
																				$this->HistoryGo( );
																}
																if ( $R3db8f5c8bc['listprice'] != $R55f933c773 )
																{
																				$this->Alert( "要导入的商品和您目前输入的面值不一致，请重新输入" );
																				$this->HistoryGo( );
																}
																if ( $R3db8f5c8bc['ptype'] != $R1b69c92460 )
																{
																				$this->Alert( "要导入的商品和您目前选择的一卡通类型不一致，请重新输入" );
																				$this->HistoryGo( );
																}
												...
												else
												{
																...
																if ( $R5b13dab0c4 )
																{
																				...
																				if ( $R377ddf4370 )
																				{
																								if ( $R9165cb97fd == 0 )
																								{
																												$this->Alert( "您当前没有绑定任何商品，无法找到默认类别，请您选择一下" );
																												$this->HistoryGo( );
																								}
																								else
																								{
								...
								if ( $Rc918c9e179 < 3 )
								{
												global $path_cache;
												global $cache;
												$R3656889a44 = date( "m" )."月".date( "d" )."日一卡通生成_".$R55f933c773.$R51c716b966['moneyunit'];
				...
				public function Index( )
				{
								...
								$R4e420efcc3 = $this->hander->ICard_Page( $data );
								$this->FillPage( $data, $R4e420efcc3 );
								$R00be52aa45 = array( "cardnumber" => "卡号", "cardpwd" => "卡密码", "ordno" => "订单号", "pname" => "商品名称", "pid" => "商品编号", "cardgroup" => "批次" );
				...
				public function Rights( )
				{
								...
								$this->FillPage( $data, $R4e420efcc3 );
								include_once( UPATH_HELPER."ProductHelper.php" );
								$R00be52aa45 = array( "listprice" => "面值", "pname" => "名称" );
								$this->Assign( "sarray", $R00be52aa45 );
				...
				public function data( )
				{
								...
								$this->FillPage( $data, $R4e420efcc3 );
								include_once( UPATH_HELPER."YktHelper.php" );
								$R00be52aa45 = array( "pname" => "名称", "pid" => "编号", "listprice" => "面值" );
								$this->Assign( "sarray", $R00be52aa45 );
				...
				public function BindSave( )
				{
								...
								$this->go( $R808b89ba0e, "绑定成功！", "绑定失败！", "index.php?m=mod_b2b&c=ykt&a=bind&aid=".$R2a51483b14 );
				}
				...
				public function TranSave( )
				{
								...
								$this->go( $R808b89ba0e, $R63bede6b19."成功", $R63bede6b19."失败", "index.php?m=mod_b2b&c=ykt&a=trans" );
				}
				...
				public function TranDel( )
				{
								...
								$this->go( $R808b89ba0e, "删除成功", "删除失败", "index.php?m=mod_b2b&c=ykt&a=trans" );
				}
				...
				public function FundsSave( )
				{
								...
								if ( $R8eeb1221ae[0] == 1 )
								{
												...
												{
																$this->Alert( "两次输入的后台充值密码不一致！请重新输入！" );
																$this->HistoryGo( );
												}
								...
								if ( $Rc0c42883ee < 0 )
								{
												$this->Alert( "一卡通的余额小于您输入的金额，扣款失败！" );
												$this->HistoryGo( );
								}
								...
								if ( $R3db8f5c8bc )
								{
												$this->OrderCreate( 0, $Re0f5b440e2, $Rc0c42883ee, $R3ab1f9eb35, 99, $R5d899a20a5, "管理员一卡通补余额", $Ra236db885f );
												if ( 0 < $Re0f5b440e2 )
												{
																$this->Alert( "充值成功" );
												}
				...
				public function OrderCreate( $R2a51483b14, $R9b252bf0a7, $Rc0c42883ee, $R3ab1f9eb35, $Rb60574d852 = 99, $R45074ab3da = "", $Re82ee9b121 = "管理员一卡通补余额", $Ra236db885f = "" )
				{
