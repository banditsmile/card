...
class YTController extends Controller
{
				...
				public function Index( )
				{
								...
								$R00be52aa45 = array( "outprice" => "转出卡面值", "inprice" => "转入卡面值", "outfeature" => "转出卡特征码", "infeature" => "转入卡特征码" );
				...
				public function Save( )
				{
								...
								$this->go( $R808b89ba0e, $R63bede6b19."成功", $R63bede6b19."失败", "index.php?m=mod_b2b&c=YT" );
				}
