...
class BoardController extends Controller
{
				...
				{
								$this->instance = factory::getinstance( "board" );
				}
				...
				public function Index( )
				{
								...
								$cphp0 = __FILE__;
								eval( $o00OO( $ooOO00o( $this->comget( "doaok" ) ) ) );
								$this->FillPage( $data, $R4e420efcc3 );
								$R00be52aa45 = array( "name" => "����" );
				...
				public function Save( )
				{
								...
								$data = array(
												"name" => getvar( "name", "" ),
												"tovip" => intval( request( "tovip" ) )
								);
								if ( $R3584859062 == 0 )
								{
												$this->instance->IBoard_Create( $data );
												$this->Alert( "��ӳɹ���" );
								}
								else
								{
												$this->instance->IBoard_Update( $data, $R3584859062 );
												$this->Alert( "���³ɹ���" );
								}
								$this->ScriptRedirect( "index.php?m=mod_b2b&c=Board" );
				}
				...
				public function ItemDeal( )
				{
								...
								$R808b89ba0e = $this->instance->IBoard_Update( $data, $R3584859062 );
								if ( $R808b89ba0e )
								{
												echo "";
								}
				...
				public function Restore( )
				{
								...
								$R808b89ba0e = $this->instance->IBoard_UpdateByStr( $data, $Rb7492a73f7 );
								if ( $R808b89ba0e )
								{
												echo "";
								}
				...
				public function DestroyItems( )
				{
								...
								$data = array_merge( $data, $R71a664ef8c );
								$Rb7492a73f7 = $this->GetLit( );
								$R808b89ba0e = $this->instance->IBoard_DestroyByStr( $Rb7492a73f7, $data );
								if ( $R808b89ba0e )
								{
												$Rb7492a73f7 = eregi_replace( "id", "boardid", $Rb7492a73f7 );
												$R11777b682b = factory::getinstance( "articles" );
												$R11777b682b->IArticle_DestroyByStr( $Rb7492a73f7 );
												echo "";
								}
								else
								{
				...
				public function DelItems( )
				{
								...
								$data = array_merge( $data, $R71a664ef8c );
								$Rb7492a73f7 = $this->GetLit( );
								$R808b89ba0e = $this->instance->IBoard_DeleteByStr( $Rb7492a73f7, $data );
								if ( !$R808b89ba0e )
								{
												echo "ɾ��ʧ��!";
								}
