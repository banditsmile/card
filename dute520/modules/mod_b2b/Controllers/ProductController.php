...
class ProductController extends Controller
{
    ...
    $this->Assign('recycle_num', $Rb749275e94);
								...
								$R60d44bd111 = array( "pname" => "��Ʒ����", "pids" => "��Ʒ���" );
								if ( $Rfff462d8f8 == 1 )
								{
												$R60d44bd111['aid'] = "����������";
								}
				...
				public function PriceSave( )
				{
								...
								$this->go( $R808b89ba0e, "�����ɹ���", "����ʧ�ܣ�", "index.php?m=mod_b2b&c=product&a=price&pid=".$R8e8b5578f7 );
				}
				...
				public function PP( )
				{
								...
								$R00be52aa45 = array( "aname" => "�û���", "arealname" => "��ʵ����", "cqq" => "QQ", "cmail" => "����", "ctel" => "�绰", "caddr" => "סַ", "cremain" => "������", "ccsmp" => "�������", "prv" => "ʡ", "city" => "��", "zip" => "�ʱ�", "remarks" => "��ע" );
								$this->Assign( "sarray", $R00be52aa45 );
