...
class PSController extends Controller
{
								...
								if ( $R300c46f603 != "" )
								{
												...
												for ( $Ra16d228039 = 0;	$Ra16d228039 < count( $R4e420efcc3['item'] );	$Ra16d228039++	)
												{
																...
																else
																{
																				...
																				$R4e420efcc3['item'][$Ra16d228039]['supstocks'] = "<font color=\"#6c6c6c\">无供货商</font>";
				...
				public function Stock( )
				{
								...
								{
												$this->Assign( "tabletitle", "卡密" );
								}
								else
								{
												$this->Assign( "tabletitle", "充值" );
								}
				...
				public function Create( )
				{
								...
								{
												$this->Alert( "还没有添加分类，请先添加分类再添加商品" );
				...
				public function ItemDeal( )
				{
								...
								{
												echo "修改失败！由于商品对外供货，有可能是通信问题导致的失败！";
								}
				}
				...
				public function UpdateTplBySup( )
				{
								...
								{
												$this->Assign( "err", "本次更新有失败，请您<a href=\"index.php?m=mod_b2b&c=PS&a=UpdateTplBySup\"><u>重新更新</u></a>！" );
								}
								else
								{
												$this->Assign( "err1", "完成更新！本次有 <font color=\"#0000ff\">".$Ra7b9a38368."</font> 个商品对接非本类型商品" );
												$this->Assign( "err2", "完成更新！本次有 <font color=\"#0000ff\">".$Ra16d228039."</font> 个自动充值商品模板做了修改" );
								}
