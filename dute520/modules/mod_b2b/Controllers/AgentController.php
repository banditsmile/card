...
class AgentController extends Controller
{
				...
				public function FundsSave( )
				{
								...
								if ( $R3db8f5c8bc )
								{
												$this->OrderCreate( $R2a51483b14, $Re0f5b440e2, $Rc0c42883ee, $R3ab1f9eb35, 99, $R5d899a20a5, "管理员充值", $Ra236db885f );
												if ( 0 < $Re0f5b440e2 )
												{
																$this->Alert( "充值成功" );
												}
				...
				public function OrderCreate( $R2a51483b14, $R9b252bf0a7, $Rc0c42883ee, $R3ab1f9eb35, $Rb60574d852 = 99, $R45074ab3da = "", $Re82ee9b121 = "管理员充值", $Ra236db885f = "" )
				{
				...
				public function LockSave( )
				{
								...
								{
												$this->Alert( "操作对象和转化对象不能一致，请重新选择" );
												$this->HistoryGo( );
								}
								if ( $R6c0fcd4a5d == "income" )
								{
												$this->Alert( "不能把金额转化为代理所得利润，请重新选择" );
												$this->HistoryGo( );
								}
								if ( $R6c0fcd4a5d == "funds" )
								{
												$this->Alert( "不能把金额转化为供货所得收入，请重新选择" );
												$this->HistoryGo( );
								}
								$R2a51483b14 = intval( request( "aid" ) );
								...
								if ( $R808b89ba0e )
								{
												...
												$Re82ee9b121 = sprintf( "系统：%s 转化为 %s！转化金额：%s 原因：".$Rfb0c285961, $Rd8fb5ae7df[$Rd4d7350af1], $Rd8fb5ae7df[$R6c0fcd4a5d], $R9b252bf0a7 );
												if ( $Rd4d7350af1 == "aremain" || $R6c0fcd4a5d == "aremain" )
												{
																...
																if ( $R62388bedf2 < 5 )
																{
																				...
																				if ( !$R808b89ba0e )
																				{
																								$this->Alert( "操作异常！锁定纪录无法生成,错误码1003" );
																				}
																}
																$sess = factory::getinstance( "session" );
																$admin = $sess->admin;
																...
																if ( !$R808b89ba0e )
																{
																				$this->Alert( "操作异常！相关纪录无法生成,错误码1001" );
																}
																...
																if ( $Rd4d7350af1 == "income" || $Rd4d7350af1 == "funds" )
																{
																				...
																				if ( !$R808b89ba0e )
																				{
																								$this->Alert( "操作异常！相关纪录无法生成,错误码1002" );
																				}
																}
												}
								}
								...
								{
												$this->Alert( "操作异常！相关纪录无法生成,错误码1004" );
								}
								$this->go( $R808b89ba0e, "操作成功", "操作失败", "index.php?m=mod_b2b&c=agent&a=lock&aid=".$R2a51483b14 );
				}
