...
class OrderController extends Controller
{
				...
				public function Index( )
				{
								...
								$R00be52aa45 = array( "ordno" => "订单号", "cid" => "用户编号", "pid" => "商品编号", "remarks" => "订单备注", "aname" => "用户名", "cname" => "操作者", "pname" => "商品名", "cqq" => "QQ号", "ctel" => "电话", "cmail" => "邮箱", "czaccount" => "充值帐号", "cip" => "IP", "cardnumber" => "卡号", "admname" => "代充管理员" );
								$R8dc7d3eb73 = array( "0" => "所有平台", "1" => "批发", "2" => "零售", "3" => "一卡通" );
								$R4d5c62f7b3 = array( "" => "全部订单", "w|cz" => "待充值订单", "s|cz" => "成功订单", "u|cz" => "失败订单", "sd|w" => "未代充手工", "sd|d" => "未充值手工", "sd" => "手工记录" );
				...
				public function Cetail( )
				{
								...
								if ( !isset( $ect ) )
								{
												$ect = array( "厂商系统出错或维护，无法充值，请稍后重新购买", "充值帐户不符，无法充值，请重新下单购买", "充值区域不符，无法充值，请重新下单购买", "商品库存不足，请待我们补充库存后再购买", "由于厂商或者一些不可控因素，无法充值，请重新提交订单" );
								}
				...
				public function Check( )
				{
								...
								if ( $Rebd5a5dade['ordstate'] == 2 )
								{
												...
												{
																$this->Alert( "您没有处理此订单的权限，请联系超级管理员" );
																$this->HistoryGo( );
												}
								}
								...
								if ( $Rb60574d852 == 98 )
								{
												...
												if ( $Rbdf46d6e43 == 2 && ( $R4bef9862f8 = $UN_1 || $R4bef9862f8 == 3 ) )
												{
																if ( $this->rollbackcan )
																{
																				...
																				{
																								$this->Alert( "商品价格有问题导致代理利润错误，请手动查看利润报表并自行扣除！" );
																				}
																				if ( 0 < $R2a51483b14 )
																				{
				...
				public function RollBackAgentMoney( $Rdcd9105806 )
				{
								...
								if ( $R808b89ba0e )
								{
												...
												if ( $R808b89ba0e )
												{
																...
																$this->UpdateTrade( $R2a51483b14, 1, $R56ea904d53['ordno'], 0, "(订单失败退款)".$R56ea904d53['pname'], $R4f39743f74, $R56ea904d53['qty'], $R9b252bf0a7, 0, $Rc0c42883ee, $R3ab1f9eb35, $R9b252bf0a7, 0 );
																$Rae8a26f24a = factory::getinstance( $this->tradetable );
																$data = array( "state" => -1 );
																$Rae8a26f24a->ITrade_UpdateByOrdno( $data, $Rdcd9105806 );
																return true;
				...
				public function RollBackFunds( $R2a51483b14, $R9b252bf0a7, $Rdcd9105806, $R56ea904d53 )
				{
								...
								if ( $Rd8fb5ae7df < 0 )
								{
												$this->Alert( "您的供货所得金额太少，本次操作无法进行，请把对应供货商的余额转入他的供货所得，再进行退款操作！" );
												return false;
								}
								$data = array(
												"funds" => $Rd8fb5ae7df
				...
				public function PowerLvSave( )
				{
								...
								$this->go( $R808b89ba0e, $R63bede6b19."成功", $R63bede6b19."失败", "index.php?m=mod_b2b&c=order&a=detail&ubzordno=".$Rdcd9105806 );
				}
				...
				public function Often( )
				{
								...
								$R00be52aa45 = array( "cid" => "用户编号", "pid" => "商品编号", "aid" => "商品所有者", "cname" => "操作者", "cqq" => "QQ号", "ctel" => "电话", "cmail" => "邮箱", "czaccount" => "充值帐号", "cip" => "IP", "cardnumber" => "卡号", "admname" => "代充管理员" );
								$R4d5c62f7b3 = array( "" => "全部订单", "s" => "成功订单", "u" => "失败订单", "w" => "未代充订单", "d" => "未充值订单" );
								$this->Assign( "oarray", $R4d5c62f7b3 );
								$this->Assign( "sarray", $R00be52aa45 );
