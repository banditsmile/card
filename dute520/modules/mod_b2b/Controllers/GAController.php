...
class GAController extends Controller
{
				...
				public function Index( )
				{
								...
								$Rbdbc624178 = array(
												array( "name" => "不启用", "value" => "none" ),
												array( "name" => "文本输入框", "value" => "text" ),
												array( "name" => "密码框", "value" => "password" ),
												array( "name" => "单选框", "value" => "radio" ),
												array( "name" => "下拉菜单", "value" => "select" )
								);
				...
				{
								$R2e3939cda7 = array( "0" => "无充值区域选择", "1" => "有充值区域选择", "2" => "购买客户自行输入充值区域" );
								$R66af8b6ab1 = array( "0" => "无充值服务器选择", "1" => "有充值服务器选择", "2" => "购买客户自行输入充值服务器" );
								$R91d25cb1c5 = array( "0" => "不共享给自有商品", "1" => "共享给自有商品" );
								$Ra3d57d5152 = factory::getinstance( "game" );
								$R69f05bd302 = $Ra3d57d5152->IGame_Get( );
								$Rbdbc624178 = array(
												array( "name" => "不启用", "value" => "none" ),
				...
				public function CreateHtml( )
				{
												...
												for ( $Ra16d228039 = 1;	$Ra16d228039 < 4;	$Ra16d228039++	)
												{
																...
																if ( $R4878d8074f != "none" )
																{
																				...
																				case "select" :
																								...
																								$Rb813fe0dc6 = explode( ",", $R050d05de12 );
																								$Rd82f3074a7 = "<option value=''>请选择</option>";
																								foreach ( $Rb813fe0dc6 as $R0f8134fb60 )
																								{
								...
								if ( 0 < $R49bbbc2f6a )
								{
												...
												if ( 0 < count( $R511b772072 ) )
												{
																...
																$Rd10c8605ef[] = "充值区域";
																$Rdb29ec38cd[] = "select";
																$R332caeb6fc = "<tr><td class='ltjs'>充值区域：</td><td class='rtjs'><select id='ubzczarea1' name='ubzczarea1' border='0' style='padding:5px;' ".$R1a8a6ef768.">"."<option value='' selected>请选择充值区域</option>".$R332caeb6fc."</select></td>";
												}
												$R332caeb6fc .= "</select>";
												$Rbdee6550e4 = "";
												$R5e11d80105 = "";
												...
												if ( 0 < count( $R511b772072 ) && 0 < count( $R3db8f5c8bc ) - count( $R511b772072 ) )
												{
																...
																$R5e11d80105 = "<tr><td class='ltjs'>服务器：</td><td class='rtjs'><select id='ubzczarea2' name='ubzczarea2' border='0' style='padding:5px;'><option value='' selected>请选择充值服务器</option></select></td>";
												}
								}
								else
								{
												if ( $R2e3939cda7 == 2 )
												{
																...
																$Rd10c8605ef[] = "充值区域";
																$Rdb29ec38cd[] = "text";
																$R332caeb6fc = "<tr><td class='ltjs'>充值区域：</td><td class='rtjs'><input type='text' id='ubzczarea1' class='input' name='ubzczarea1'> * </td></tr>";
												}
												if ( $R66af8b6ab1 == 2 )
												{
																$R10074df755[] = "ubzczarea2";
																$Rd10c8605ef[] = "充值服务器";
																$Rdb29ec38cd[] = "text";
																$R5e11d80105 = "<tr><td class='ltjs'>充值服务器：</td><td class='rtjs'><input type='text' id='ubzczarea2' class='input' name='ubzczarea2'> * </td></tr>";
												}
								}
								$R63bede6b19 = "";
								...
								$R63bede6b19 = $R63bede6b19."function setserv(obj){"."var selectval=obj.options[obj.selectedIndex].value;"."tmp=selectval.split(\"||\");"."i=0;"."\$(\"ubzczarea2\").length=0;"."\$(\"ubzczarea2\").options[\$(\"ubzczarea2\").length] = new Option(\"请选择服务器\", \"\");"."for(i=0;i<serv.length;i++){"."if(serv[i][0]==tmp[0]){"."\$(\"ubzczarea2\").options[\$(\"ubzczarea2\").length] = new Option(serv[i][1], serv[i][1]);"."}"."}"."}";
