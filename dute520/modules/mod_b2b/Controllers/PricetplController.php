...
class CatalogController extends Controller
{
				...
				{
								$this->instance = factory::getinstance( "catalog" );
				}
				...
				public function Index( )
				{
								...
								$R4e420efcc3 = $this->instance->ICatalog_Page( $data );
								$this->FillPage( $data, $R4e420efcc3 );
								$R00be52aa45 = array( "name" => "名称", "keyword" => "关键词", "pinyin" => "首字母", "ordering" => "排序" );
				...
				public function Detail( )
				{
								...
								$this->Assign( "item", $this->instance->ICatalog_GetById( $R3584859062 ) );
				...
				public function Save( )
				{
								...
								if ( $R3584859062 == 0 )
								{
												$this->instance->ICatalog_Create( $data );
												$this->Alert( "添加成功！" );
								}
								else
								{
												$this->instance->ICatalog_Update( $data, $R3584859062 );
												$this->Alert( "更新成功！" );
								}
								$this->ScriptRedirect( "index.php?m=mod_b2b&c=catalog" );
				}
				...
				public function DestroyItems( )
				{
								...
								$data = array_merge( $data, $R71a664ef8c );
								$Rb7492a73f7 = $this->GetLit( );
								$R808b89ba0e = $this->instance->ICatalog_DestroyByStr( $Rb7492a73f7, $data );
								if ( $R808b89ba0e )
								{
												echo "";
								}
