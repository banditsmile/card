...
class AreaController extends Controller
{
				...
				public function Index( )
				{
								...
								if ( $R49bbbc2f6a == 0 )
								{
												$this->Alert( "您还没有配置区服模板！请先配置好后再选则" );
												$this->HistoryGo( );
								}
								if ( $R69f05bd302 == "" )
								{
				...
				public function Save( )
				{
								...
								if ( 0 < $R3584859062 && $R124c4e44f6 == 0 && 0 < $Rac9b8532b8 )
								{
												...
												{
																$this->Alert( "目前设置的项还含有服务器，请先删除他底下的服务器再把他转到另外一个区域下！" );
																$this->HistoryGo( );
												}
								}
								$data = array(
								...
								$this->go( $R808b89ba0e, $R63bede6b19."成功！", $R63bede6b19."失败", "index.php?m=mod_b2b&c=area&id=".$R49bbbc2f6a."&game=".$R69f05bd302 );
				}
