...
$tabletpl = array(
				...
				"tpid" => array( "width" => "65", "headHtml" => "<b>商品编号</b>", "bodyHtml" => "{\$item['pid']}" ),
				...
				"quickcheck" => array( "width" => "35", "headHtml" => "<b>提交</b>", "bodyHtml" => "<!--if(\$item['ordstate']!=1 && \$item['ptype']==2 ){--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==1 ? 0 : 1)}\" /><!--}else{--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==1 ? 0 : 1)}\" onclick=\"toToggle(this,'{\$item['ordno']}','ordstate')\" alt=\"点此马上修改订单状态为交易完成状态！\" onFocus=\"this.blur()\" class=\"mousehand\"/><!--}-->" ),
				"suc" => array( "width" => "35", "headHtml" => "<b>成功</b>", "bodyHtml" => "<!--if(\$item['sup'] != 1 && \$item['ptype']==2 ) {--><!--if(\$item['ordstate']==2){--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==2 ? 1 : 0)}\" /><!--}else{--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==2 ? 1 : 0)}\" onclick=\"toToggle(this,'{\$item['ordno']}','ordstate3')\" alt=\"点此马上修改订单状态为交易完成状态！\" onFocus=\"this.blur()\" class=\"mousehand\"/><!--}--><!--}else{-->--<!--}-->" ),
				"cz" => array( "width" => "40", "headHtml" => "<b>代充</b>", "bodyHtml" => "<!--if(\$item['sup'] != 1 && \$item['ptype']==2 ) {--><input type=\"button\" value=\"代充\" class=\"button\" style=\"width:35px;\" onclick=\"window.location='?m=mod_b2b&c=order&a=cetail&ubzordno={\$item['ordno']}'\"/><!--}else{-->--<!--}-->" ),
