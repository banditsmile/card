...
$tabletpl = array(
				...
				"company" => array( "width" => "160", "headHtml" => "<span class=\"canedit\">公司名称</span>", "bodyHtml" => "<nobr><samp title=\"{\$item['company']}\"><span onclick=\"toInput(this,{\$item['aid']},'company')\">{\$item['company']}</span></samp></nobr>" ),
				...
				"prv" => array( "width" => "60", "headHtml" => "<span class=\"canedit\">省</span>", "bodyHtml" => "<nobr><samp title=\"{\$item['prv']}\"><span onclick=\"toInput(this,{\$item['aid']},'prv')\">{\$item['prv']}</span></samp></nobr>" ),
				"city" => array( "width" => "60", "headHtml" => "<span class=\"canedit\">市</span>", "bodyHtml" => "<nobr><samp title=\"{\$item['city']}\"><span onclick=\"toInput(this,{\$item['aid']},'city')\">{\$item['city']}</span></samp></nobr>" ),
				...
				"realname" => array( "width" => "70", "headHtml" => "<span class=\"canedit\">联系人</span>", "bodyHtml" => "<nobr><samp title=\"{\$item['arealname']}\"><span onclick=\"toInput(this,{\$item['aid']},'arealname')\">{\$item['arealname']}</span></samp></nobr>" ),
