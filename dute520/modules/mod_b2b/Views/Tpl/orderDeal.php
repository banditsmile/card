...
$tabletpl = array(
				...
				"tadmin" => array( "width" => "120", "headHtml" => "<b>代充管理员</b>", "bodyHtml" => "<!--if(\$vd['admname']==\$item['admname']){--><font color=\"#ff0000\"><!--}-->{\$item['admname']}<!--if(\$vd['admname']==\$item['admname']){--></font><!--}-->" ),
				...
				"quickcheck" => array( "width" => "35", "headHtml" => "<b>成功</b>", "bodyHtml" => "<!--if(\$item['sup'] != 1) {--><!--if(\$item['ordstate']==2){--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==2 ? 1 : 0)}\" /><!--}else{--><img src=\"{\$vd['sc']}{#ToggleImgSrc(\$item['ordstate']==2 ? 1 : 0)}\" onclick=\"toToggle(this,'{\$item['ordno']}','ordstate3')\" alt=\"点此马上修改订单状态为交易完成状态！\" onFocus=\"this.blur()\" class=\"mousehand\"/><!--}--><!--}else{-->--<!--}-->" ),
