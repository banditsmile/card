...
class HomeController extends Controller
{
				...
				public function Left( )
				{
								...
								$leftinfo = array(
												array(
																...
																"id" => array( 0, 0, 0 ),
																"val" => array(
																				array( "id" => 99999, "txt" => "ϵͳ����", "url" => "?c=Home&a=Home", "nobr" => 1 ),
																				array( "id" => 0, "txt" => "ƽ̨��������", "url" => "?m=mod_b2b&c=Sys" ),
																				array( "id" => 30, "txt" => "�������", "url" => "?m=mod_b2b&c=Article&a=Add" ),
																				array( "id" => 34, "txt" => "���¶���", "url" => "?m=mod_b2b&c=Order&aid=-2" ),
																				array( "id" => 16, "txt" => "��Ʒ�б�", "url" => "?m=mod_b2b&c=Product&ptype=-1&aid=-1" ),
																				array( "id" => 16, "txt" => "�����Ʒ", "url" => "?m=mod_b2b&c=PS&a=create" ),
																				array( "id" => 24, "txt" => "�����ӿ�", "url" => "?m=mod_b2b&c=Card&a=Add" ),
																				array( "id" => 26, "txt" => "�����û�", "url" => "?m=mod_b2b&c=Agent" ),
																				array( "id" => 35, "txt" => "�û���ֵ��¼", "url" => "?m=mod_b2b&c=Funds" ),
																				array( "id" => 32, "txt" => "δ��վ����", "url" => "?m=mod_b2b&c=PM&msgto=0&isreaded=-1&msgtype=1&by=1" ),
																				array( "id" => 33, "txt" => "����δ������Ϣ", "url" => "?m=mod_b2b&c=Msg&optype=r&ubzisreaded=0" ),
																				array( "id" => 35, "txt" => "ƽ̨���󱨱�", "url" => "?m=mod_b2b&c=Profit&aid=-1&s=1" ),
																				array( "id" => 99999, "txt" => "�˳�", "url" => "?c=Home&a=Logout" )
																)
												)
								);
								$R026f0167b4 = array( );
				...
				public function Save( )
				{
								...
								{
												$this->AddLogin( 0, 0, $Re8bade8a5f, 0, 0, "�ܱ�������󣬵�½ʧ��", 0 );
												$this->Alert( "�ܱ�����������������룡" );
												$this->HistoryGo( );
								}
								if ( $this->VerifyMobile( $Re8bade8a5f ) == 0 )
								{
												$this->AddLogin( 0, 0, $Re8bade8a5f, 0, 0, "����������󣬵�½ʧ��", 0 );
												$this->Alert( "��������������������룡" );
												$this->HistoryGo( );
								}
								if ( !$R808b89ba0e )
								{
												...
												$this->AddLogin( $R3db8f5c8bc['id'], 0, $Re8bade8a5f, 0, 0, "�ɹ���½", 1 );
								...
								{
												$this->AddLogin( 0, 0, $Re8bade8a5f, 0, 0, "�Ǳ�����¼����½ʧ��", 0 );
												$this->Alert( "�Ǳ�����¼��" );
												$this->View( "Login" );
								}
				...
				public function GetText( )
				{
								...
								$R63bede6b19 = "<a href=\"index.php?m=mod_b2b&c=PM&msgto=0&isreaded=-1&msgtype=1&by=1\" target=\"frmright\">��Ϣ<font color=\"#ff0000\"><span id=\"newpm\">".$this->newpm( 1 )."</span></font>��</a>"." <a href=\"index.php?m=mod_b2b&c=Remit&msgto=0&mstate=1&by=1\" target=\"frmright\">���<font color=\"#ff0000\"><span id=\"newhk\">".$this->newpm( 2 )."</span></font>��</a>"." <a href=\"index.php?m=mod_b2b&c=Complaint&msgto=0&mstate=1&by=1\" target=\"frmright\">Ͷ��<font color=\"#ff0000\"><span id=\"newts\">".$this->newpm( 3 )."</span></font>��</a>"." <a href=\"index.php?m=mod_b2b&c=Order&a=CzList&optype=sd|w&by=1&aid=-2\" target=\"frmright\">�ֶ�<font color=\"#ff0000\"><span id=\"notdealorder\">".$this->getnotdealorderbystr( " ptype=2 and aid < 1 and inrecycle = 0 and ordstate=1 " )."</span></font>��</a>"." <a href=\"index.php?m=mod_b2b&c=Order&optype=zd|w&by=1&aid=-2\" target=\"frmright\">�Զ�<font color=\"#ff0000\"><span id=\"notdealorder1\">".$this->getnotdealorderbystr( " ptype=1 and aid < 1 and inrecycle = 0 and ordstate=1 " )."</span></font>��</a>"." <a href=\"index.php?m=mod_b2b&c=Order&optype=km|w&by=1&aid=-2\" target=\"frmright\">����<font color=\"#ff0000\"><span id=\"notdealorder2\">".$this->getnotdealorderbystr( " (ptype=0 or ptype=3 or ptype>99) and aid < 1 and inrecycle = 0 and ordstate=1 " )."</span></font>��</a>";
								echo $R63bede6b19;
				}
